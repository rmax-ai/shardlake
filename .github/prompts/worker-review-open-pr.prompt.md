...
If any check in this prompt shows the PR has merge conflicts, ensure the `has-merge-conflicts` label exists, add that label to the PR, do not label the PR `ready-to-merge` in this run, and report the conflict clearly as the blocker.
