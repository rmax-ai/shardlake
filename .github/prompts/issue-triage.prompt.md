...
5. Build the desired ready queue deterministically:
   ...
   - select the first eligible child issues whose author login passes the workflow actor guard rail until 5 open issues are selected
...
10. Verify the final open `ready-to-implement` count is at most 5.
